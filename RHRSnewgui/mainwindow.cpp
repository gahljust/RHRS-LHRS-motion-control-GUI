    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->setupUi(this);
    this->setWindowTitle("Velmex Motor Controller Right Arm");
...
// the x axis of the main motors is actually controlled by the varible y, and the y axis of the main motors is controlled by the varible x.
    ...
    yPainter.drawRect(508,480,22,22.6);
    ...
    textpainter.drawText(530,330,"Right Arm Main Motors");
    textpainter.drawText(75,330,"Right Arm A_T Detectors");
