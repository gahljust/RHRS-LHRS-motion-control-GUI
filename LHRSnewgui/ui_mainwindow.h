...
""));
        ...
        btnAdvanced->setStyleSheet(QString::fromUtf8("background-color: rgb(97, 240, 143)"));
...
"border: none;"));
        ...
        btnAverageUser->setStyleSheet(QString::fromUtf8("background-color: rgb(146, 240, 45);"));
